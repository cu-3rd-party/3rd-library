...
import { ModerationTabValue } from "@/features/moderate-submission/model";
import {
  ModerationTabs,
  SubmissionReviewDialog,
} from "@/features/moderate-submission/ui";
...
const ModerationPage = () => {
  ...
  const loadSubmissions = useCallback(async () => {
    ...
    try {
      ...
      const payload = await fetchJsonWithAuth<LibraryModerationResponse>(
  ...
  const openSubmission = async (submission: MaterialSubmission) => {
    ...
    try {
      const payload = await fetchJsonWithAuth<LibrarySubmission>(
        resolveApiUrl(
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetchJsonWithAuth<LibrarySubmission>(
        resolveApiUrl(
