...
const buttonVariants = cva(
  ...
  ease-in-out disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0
  ...
  dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive`,
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive-liquid text-destructive hover:bg-destructive-liquid/90",
        outline: "border-1 bg-card hover:border-ring border-border",
        secondary:
